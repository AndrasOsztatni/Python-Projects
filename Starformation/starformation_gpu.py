...
G = 1.0
M = 2.0
N = 4000  # Particle count (adjust based on your GPU's frame rate)
R = 1.0
OMEGA = 1.0

# With the sink particle removing the ultra-dense core, 
# we can safely run at a much faster time step!
TIME_STEP = 0.005  
SOFT_PARAM = 0.1
